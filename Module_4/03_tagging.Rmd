...
```{r Downloading, eval=FALSE,echo=TRUE}
...
```{r loading, eval=FALSE,echo=TRUE}
...
```{r tagging, eval=FALSE,echo=TRUE}
...
```{r plot_verbs, eval=FALSE,echo=TRUE}
Verbs.top%>%
...
```{r nouns_verbs, eval=FALSE,echo=TRUE}
...
```{r nouns+adjectives, eval=FALSE,echo=TRUE}
...
```{r Collocates, eval=FALSE,echo=TRUE}
